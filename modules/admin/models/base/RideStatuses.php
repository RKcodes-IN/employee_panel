...
/**
 * This is the base model class for table "ride_statuses".
 *
 * @property integer $id
 ...
 */
class RideStatuses extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\RideStatusesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\RideStatusesQuery(get_called_class());
    }
