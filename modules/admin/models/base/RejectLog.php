...
/**
 * This is the base model class for table "reject_log".
 *
 * @property integer $id
 ...
 */
class RejectLog extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\RejectLogQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\RejectLogQuery(get_called_class());
    }
