...
/**
 * app\modules\admin\models\search\VehicalsSearch represents the model behind the search form about `app\modules\admin\models\Vehicals`.
 */
 class VehicalsSearch extends Vehicals
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Vehicals::find()->where(['status'=>Vehicals::STATUS_ACTIVE])->orWhere(['status'=>Vehicals::STATUS_INACTIVE]);
