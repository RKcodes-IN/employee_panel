...
class UserSearch extends User
{
	...
	public function referalSearch($params, $user_id = null)
	{

		$query = User::find()->where(['!=','referal_id',0]);
		// print_r(
		// $reffredUser->createCommand()->getRawSql()
		
		// );exit;

		// var_dump($reffredUser);
		// foreach($reffredUser as $user){
		// 	$query = User::find()->where(['referal_id' => $user->id]);
