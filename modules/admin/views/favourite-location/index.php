...
/* @var $searchModel app\modules\admin\models\search\FavouriteLocationSearch */
...
$this->title = Yii::t('app', 'Favourite Locations');
...
?>
<div class="favourite-location-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Favourite Location'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-favourite-location-search-user_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-favourite-location']],
        'panel' => [
            'type' => 'light',
