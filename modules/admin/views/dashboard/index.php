            ...
            <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1100">
               <div class="card-body">
                  <div class="progress-widget">
                     ...
                     <div class="progress-detail">
                        <p class="mb-2">Completed Rides</p>
                        <h4 class="counter"></h4>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="progress-widget">
                     ...
                     <div class="progress-detail">
                        ...
                        <h4 class="counter"><?php
                                             ...
                                             echo "₹" . round($total_earnings, 2) ?></h4>
                     </div>
                  </div>
               </div>
            </li>
...
<div class="col-md-12 col-lg-12">
   <div class="row">
      ...
      <?php $rideRequestCount = RideRequest::find()->Where(['between', 'created_on', date('Y-m-d 00:00:00'), date('Y-m-d 00:00:00', strtotime("+1 days"))])->count(); ?>
      <div class="col-md-12 col-lg-12">
         <div class="overflow-hidden card" data-aos="fade-up" data-aos-delay="600">
            <div class="flex-wrap card-header d-flex justify-content-between">
               <div class="header-title">
                  <h4 class="mb-2 card-title">Recent Ride Request</h4>
                  <p class="mb-0">
                     <svg class="me-2 text-primary" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" />
                     </svg>
                     <?= $rideRequestCount ?> New Ride Request Today
                  </p>
               </div>
               <!-- <div class="dropdown">
            ...
            <?php $rideRequests = RideRequest::find()->Where(['between', 'created_on', date('Y-m-d 00:00:00'), date('Y-m-d 00:00:00', strtotime("+1 days"))])->limit(5)->orderBy(['id' => SORT_DESC])->all();
            // print_r($rideRequests->createCommand()->getRawSql());exit;
            // var_dump($rideRequests);exit;
            ?>
               ...
               <div class="mt-4 table-responsive">
                  <?php if (!empty($rideRequests)) { ?>
                     <table id="basic-table" class="table mb-0 table-striped" role="grid">
                        ...
                        <tbody>
                           <?php foreach ($rideRequests as $rr) { ?>
                              <tr>
                                 <td>
                                    <?= $rr->id ?>
                                 </td>
                                 <td>
                                    <?= $rr->pickup_address ?>, <?= $rr->pickup_pincode ?>
                                 </td>
                                 <td>
                                    <?= $rr->drop_address ?>, <?= $rr->drop_pincode ?>


                                 </td>
                                 <td>
                                    <?php if ($rr->final_price == 0) {
                                       echo $rr->estimated_ride_fare;
                                    } else {
                                       echo $rr->final_price;
                                    } ?>
                  ...
                  <?php } else { ?>
                     <p class="text-center">No Recent Rides</p>
                  <?php } ?>
               </div>
            </div>
         </div>
