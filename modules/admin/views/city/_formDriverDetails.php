...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'user_id' => [
            ...
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\UserSearch::find()->orderBy('username')->asArray()->all(), 'id', 'username'),
    ...
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="fa fa-plus"></i>' . Yii::t('app', 'Add Skipper Details'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowDriverDetails()']),
        ]
    ]
]);
echo  "    </div>\n\n";
