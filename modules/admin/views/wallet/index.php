...
/* @var $searchModel app\modules\admin\models\search\WalletSearch */
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-wallet-search-user_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-wallet']],
        'panel' => [
            'type' => 'light',
