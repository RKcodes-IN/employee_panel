    ...
    <section>
        ...
        <table class="table">
            <thead>
                ...
                <tr class="breaklines" style="">
                    ...
                    <th class="" width="">
                        <p style="color:#000"> <?= isset($ride_request->driver->first_name) ? $ride_request->driver->first_name : $ride_request->driver->username ?? "(Not Assigned)" ?> </p>
                    </th>
                </tr>
                <tr class="breaklines" style="">
                    <th class="">
                ...
                <tr class="breaklines" style="">
                    ...
                    <th class="" width="">
                        <p style="color:#000"><?= isset($ride_request->user->first_name) ? $ride_request->user->first_name : $ride_request->user->username ?? "(Not Assigned)" ?></p>
                    </th>
                </tr>
                <tr class="breaklines" style="">
                    <th class="">
        ...
        <table class="table">
            <thead>
                ...
                <tr class="breaklines">
                    <th class="">
                        <p style="color:#000"> <strong> <?= isset($ride_request->user->first_name) ? $ride_request->user->first_name : $ride_request->user->username ?? "(Not Assigned)" ?> </strong></p>
