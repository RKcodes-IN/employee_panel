...
<div class="row">
    ...
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <iframe src="<?= $resumes->resume_url ?>" frameborder="0" class="resume"></iframe>
    </div>
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        ...
        <div class="d-flex justify-content-between mt-3">
            ...
            <div class="form-group">
                <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Save') : Yii::t('app', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-warning' : 'btn btn-primary']) ?>
            </div>
            <div class="form-group">
                <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Next') : Yii::t('app', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-info' : 'btn btn-primary']) ?>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
    </div>
...
<script>
	$(document).ready(function() {
		// Select the element by its class "sidebar" and add the class "sidebar-mini"
