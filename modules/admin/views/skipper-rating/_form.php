...
<div class="skipper-rating-form">
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'skipper_id')->widget(\kartik\widgets\Select2::classname(), [
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'rating')->textInput(['placeholder' => 'Rating'])  ?> </div>
