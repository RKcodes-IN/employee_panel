...
/* @var $searchModel app\modules\admin\models\search\VehicalsSearch */
        ...
        <div class="card-body">
            ...
            <p>
                <?php if (\Yii::$app->user->identity->user_role == User::ROLE_ADMIN || \Yii::$app->user->identity->user_role == User::ROLE_SUBADMIN) { ?>
                    <?= Html::a(Yii::t('app', 'Create Vehicles '), ['create'], ['class' => 'btn btn-success']) ?>
                <?php  } ?>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <?= GridView::widget([
                ...
                'pjax' => true,
                'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-vehicals']],
                'panel' => [
                    'type' => 'light',
