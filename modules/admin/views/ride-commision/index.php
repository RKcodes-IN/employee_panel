...
/* @var $searchModel app\modules\admin\models\search\RideCommisionSearch */
...
$this->title = Yii::t('app', 'Ride Commisions');
...
?>
<div class="ride-commision-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Ride Commision'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'City', 'id' => 'grid-ride-commision-search-city_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Vehicles ', 'id' => 'grid-ride-commision-search-vehicle_id']
            ],
