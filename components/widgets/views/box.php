...
<div <?= $attributes ?>>
    ...
    <div <?= $headerAttributes ?>>
        ...
        <div <?= $toolsAttributes ?>>
            ...
            <?php if ($expandable) : ?>
            <button class="btn btn-sm btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
            <?php endif; ?>
            <?php if ($removable) : ?>
            <button class="btn btn-sm btn-box-tool" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>
            <?php endif; ?>
        </div>
        <?php endif; ?>
    </div>
